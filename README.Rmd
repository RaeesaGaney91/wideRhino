...
When $p > n$, then the standard CVA biplot will not work due to the singularity of the within-scatter matrix, and this is when the GSVD becomes useful. Using this simulated data with 3 groups, 100 observations and 300 variables, a CVA-GSVD biplot can be constructed: 
